...
echo   4. Double-click SPYer.bat again
echo.
pause
exit /b 1
...
:deps_ok
:: --- Launch the app ---
echo [+] Launching SPYer...
echo.
%PY% spyer.py

:: If we get here, the app closed or crashed
if !errorlevel! neq 0 (
    echo.
    echo [ERROR] SPYer exited with an error. See above.
    pause
)
